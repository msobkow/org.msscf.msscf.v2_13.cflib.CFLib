 ...
 */
@Embeddable
public class CFLibDbKeyHash512 implements Serializable, Comparator<CFLibDbKeyHash512>, Comparable<CFLibDbKeyHash512> {
  ...
  public boolean equals(Object aTest) {
    ...
    CFLibDbKeyHash512 test = (CFLibDbKeyHash512) aTest;
  ...
  @Override
  public int compare(CFLibDbKeyHash512 h1, CFLibDbKeyHash512 h2) {
    if (h1 == null && h2 != null) {
      return 1;
    }
    if (h2 == null && h1 != null) {
  ...
  @Override
  public int compareTo(CFLibDbKeyHash512 o) {
  ...
  public static final CFLibDbKeyHash512[] toDbKeyHash16(String[] ids) {
    if (ids == null) {
      return null;
    }
    if (ids.length == 0) {
  ...
  public static final List<CFLibDbKeyHash512> toDbKeyHash16List(String[] ids) {
  ...
  public static final Set<CFLibDbKeyHash512> toDbKeyHash16Set(String[] ids) {
