 ...
 */
@Embeddable
public class CFLibDbKeyHash224 implements Serializable, Comparator<CFLibDbKeyHash224>, Comparable<CFLibDbKeyHash224> {
  ...
  public boolean equals(Object aTest) {
    ...
    CFLibDbKeyHash224 test = (CFLibDbKeyHash224) aTest;
  ...
  @Override
  public int compare(CFLibDbKeyHash224 h1, CFLibDbKeyHash224 h2) {
    if (h1 == null && h2 != null) {
      return 1;
    }
    if (h2 == null && h1 != null) {
  ...
  @Override
  public int compareTo(CFLibDbKeyHash224 o) {
  ...
  public static final CFLibDbKeyHash224[] toDbKeyHash16(String[] ids) {
    if (ids == null) {
      return null;
    }
    if (ids.length == 0) {
  ...
  public static final List<CFLibDbKeyHash224> toDbKeyHash16List(String[] ids) {
  ...
  public static final Set<CFLibDbKeyHash224> toDbKeyHash16Set(String[] ids) {
