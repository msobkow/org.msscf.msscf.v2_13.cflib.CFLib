 ...
 */
@Embeddable
public class CFLibDbKeyHash160 implements Serializable, Comparator<CFLibDbKeyHash160>, Comparable<CFLibDbKeyHash160> {
  ...
  public boolean equals(Object aTest) {
    ...
    CFLibDbKeyHash160 test = (CFLibDbKeyHash160) aTest;
  ...
  @Override
  public int compare(CFLibDbKeyHash160 h1, CFLibDbKeyHash160 h2) {
    if (h1 == null && h2 != null) {
      return 1;
    }
    if (h2 == null && h1 != null) {
  ...
  @Override
  public int compareTo(CFLibDbKeyHash160 o) {
  ...
  public static final CFLibDbKeyHash160[] toDbKeyHash16(String[] ids) {
    if (ids == null) {
      return null;
    }
    if (ids.length == 0) {
  ...
  public static final List<CFLibDbKeyHash160> toDbKeyHash16List(String[] ids) {
  ...
  public static final Set<CFLibDbKeyHash160> toDbKeyHash16Set(String[] ids) {
