 ...
 */
@Embeddable
public class CFLibDbKeyHash128 implements Serializable, Comparator<CFLibDbKeyHash128>, Comparable<CFLibDbKeyHash128> {
  ...
  @Convert(converter = CFLibDbKeyHash128Converter.class)
  ...
  public CFLibDbKeyHash128(CFLibDbKeyHash128 otherKey) {
    ...
    System.arraycopy(otherKey.bytes, 0, _newId, 0, HASH_LENGTH);
    this.bytes = _newId;
  }
  ...
  public boolean equals(Object aTest) {
    ...
    CFLibDbKeyHash128 test = (CFLibDbKeyHash128) aTest;
  ...
  @Override
  public int compare(CFLibDbKeyHash128 h1, CFLibDbKeyHash128 h2) {
    if (h1 == null && h2 != null) {
      return 1;
    }
    if (h2 == null && h1 != null) {
  ...
  @Override
  public int compareTo(CFLibDbKeyHash128 o) {
  ...
  public static final CFLibDbKeyHash128[] toDbKeyHash16(String[] ids) {
    if (ids == null) {
      return null;
    }
    if (ids.length == 0) {
  ...
  public static final List<CFLibDbKeyHash128> toDbKeyHash16List(String[] ids) {
  ...
  public static final Set<CFLibDbKeyHash128> toDbKeyHash16Set(String[] ids) {
